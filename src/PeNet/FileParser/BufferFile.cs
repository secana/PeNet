...
namespace PeNet.FileParser
{
    public class BufferFile : IRawFile
    {
        ...
        public void WriteUInt(long offset, uint value) => MemoryMarshal.Write(_buffer.Span[(int)offset..], in value);

        public void WriteULong(long offset, ulong value) => MemoryMarshal.Write(_buffer.Span[(int)offset..], in value);

        public void WriteUShort(long offset, ushort value) => MemoryMarshal.Write(_buffer.Span[(int)offset..], in value);
